...
<header class="header-area header-style-1 header-height-2 text-deco">
                    ...
                    <ul>
                            <li>
                                ...
                                <ul class="language-dropdown">
                                    <li><a href="#"><img src="fe/assets/imgs/theme/flag-fr.png" alt="">Français</a></li>
                                    <li><a href="#"><img src="fe/assets/imgs/theme/flag-dt.png" alt="">Deutsch</a></li>
                                    <li><a href="#"><img src="fe/assets/imgs/theme/flag-ru.png" alt="">Pусский</a></li>
                                </ul>
                            </li>                                
                        </ul>
                    </div>
        ...
        <div class="container">
            <div class="header-wrap">
                <div class="logo logo-width-1">
                    <a href="index.html"><img src="{{asset('fe/assets/imgs/logo/logo.png')}}" alt="logo"></a>
                </div>
                    ...
                    <div class="header-action-right">
                        <div class="header-action-2">
                            <div class="header-action-icon-2">
                                <a href="{{url('wishlist')}}">
                                    <img class="svgInject" alt="Surfside Media" src="{{asset('fe/assets/imgs/theme/icons/icon-heart.svg')}}">
                            ...
                            <div class="header-action-icon-2">
                                <a class="mini-cart-icon" href="{{url('cart')}}">
                                    <img alt="Surfside Media" src="{{asset('fe/assets/imgs/theme/icons/icon-cart.svg')}}">
                                    <span class="pro-count blue">
                                    ...
                                    <ul>
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="product-details.html"><img alt="Surfside Media" src="fe/assets/imgs/shop/thumbnail-3.jpg"></a>
                                            </div>
                                        ...
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="product-details.html"><img alt="Surfside Media" src="fe/assets/imgs/shop/thumbnail-2.jpg"></a>
                                            </div>
                                            <div class="shopping-cart-title">
        ...
        <div class="container">
            <div class="header-wrap header-space-between position-relative">
                <div class="logo logo-width-1 d-block d-lg-none">
                    <a href="index.html"><img src="fe/assets/imgs/logo/logo.png" alt="logo"></a>
                </div>
                                        ...
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-5">
                                                <div class="header-banner2">
                                                    <img src="fe/assets/imgs/banner/menu-banner-2.jpg" alt="menu_banner1">
                                                ...
                                                <div class="header-banner2">
                                                    <img src="fe/assets/imgs/banner/menu-banner-3.jpg" alt="menu_banner2">
                                                    <div class="banne_info">
                                                        <h6>15% Off</h6>
                                                        <h4>Hot Deals</h4>
                                                        <a href="#">Shop now</a>
                                ...
                                <li class="has-children">
                                    ...
                                    <div class="dropdown-menu">
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-5">
                                                <div class="header-banner2">
                                                    <img src="fe/assets/imgs/banner/menu-banner-4.jpg" alt="menu_banner1">
                                                    <div class="banne_info">
                                                        <h6>10% Off</h6>
                                                        <h4>New Arrival</h4>
                                                        <a href="#">Shop now</a>
                                ...
                                <li class="has-children">
                                    ...
                                    <div class="dropdown-menu">
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-5">
                                                <div class="header-banner2">
                                                    <img src="fe/assets/imgs/banner/menu-banner-5.jpg" alt="menu_banner1">
                                                    <div class="banne_info">
                                                        <h6>10% Off</h6>
                                                        <h4>New Arrival</h4>
                                                        <a href="#">Shop now</a>
                                                ...
                                                <div class="header-banner2">
                                                    <img src="fe/assets/imgs/banner/menu-banner-6.jpg" alt="menu_banner2">
                                                    <div class="banne_info">
                                                        <h6>15% Off</h6>
                                                        <h4>Hot Deals</h4>
                                                        <a href="#">Shop now</a>
                    ...
                    <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                        <nav>
                            <ul>
                                ...
                                <li class="position-static"><a href="{{url('/collections')}}">Our Collections <i class=""></i></a>
                                    {{-- <ul class="mega-menu">
                                        ...
                                        <li class="sub-mega-menu sub-mega-menu-width-34">
                                            <div class="menu-banner-wrap">
                                                <a href="product-details.html"><img src="fe/assets/imgs/banner/menu-banner.jpg" alt="Surfside Media"></a>
                ...
                <div class="header-action-right d-block d-lg-none">
                    <div class="header-action-2">
                        <div class="header-action-icon-2">
                            <a href="{{url('wishlist')}}">
                                <img alt="Surfside Media" src="fe/assets/imgs/theme/icons/icon-heart.svg">
                                <span class="pro-count white">4</span>
                            </a>
                        </div>
                        <div class="header-action-icon-2">
                            <a class="mini-cart-icon" href="{{url('cart')}}">
                                <img alt="Surfside Media" src="fe/assets/imgs/theme/icons/icon-cart.svg">
